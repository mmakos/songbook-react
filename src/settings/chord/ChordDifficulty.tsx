        ...
        description={
          showDescription ? (
            <>
              ...
              możliwości wykonania piosenki w różnej harmonii, czasami zapisują alternatywne akordy po ukośniku, np.{' '}
              <>D/h</>. Oznacza to, że generalnie gramy D-dur, ale h-moll będzie brzmiał równie dobrze. Jeśli jednak nie
